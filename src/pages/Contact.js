          ...
          <div className="col-lg-6 d-flex align-items-stretch">
            <div className="info-wrap p-4 w-100 infobackground mx-auto my-auto">
              ...
              <div className="dbox w-100 d-flex align-items-start">
                ...
                <div className="text pl-4">
                  <p><span>Phone:</span> <a href="tel:6128367123">+1(612) 836-7123</a></p>
                </div>
              </div>
              <div className="dbox w-100 d-flex align-items-start">
                <div className="icon d-flex align-items-center justify-content-center">
                ...
                <div className="text pl-4">
                  <p><span>Email:</span> <a href="mailto:abduljabar.jobs@gmail.com">abduljabar.jobs@gmail.com</a></p>
                </div>
              </div>
              <div className="dbox w-100 d-flex align-items-start">
                <div className="icon d-flex align-items-center justify-content-center">
                ...
                <div className="text pl-4">
                  <p><span>Resume:</span> <a href={resumeUrl} target="_blank" download = "Abduljabar's_Resume.pdf"> Resume</a></p>
                </div>
              </div>
            </div>
          </div>
